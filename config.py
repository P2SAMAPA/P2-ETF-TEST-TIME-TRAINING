...
OUTPUT_REPO = "P2SAMAPA/p2-etf-test-time-training-results"
...
TTT_LEARNING_RATE = 0.0001     # test-time adaptation learning rate
TTT_STEPS = 5                  # number of adaptation steps per inference
TOP_N = 3
